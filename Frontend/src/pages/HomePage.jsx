...
import { getOutFriendsReqs, getRecommendedFriends, getUserFriends, sendFriendReq } from '../lib/api';
            ...
            <div className='container mx-auto space-y-10'>
                ...
                {loadingFriends ? (
                    ...
                    <div className='card bg-base-200 p-6 text-center'>
                        ...
                        <p className='text-base-content opacity-70'>
                            connect with language partners below to strat practicing together!
                        </p>

                    </div>
                ) : (
                    <div className='grid grid-cols-1 sm:grid-col-2 lg:grid-cols-3 xl:grid-cols-4 gap-4'>
                        {friends.map((friend) => (
                ...
                <section>
                    ...
                    {loadingUsers ? (
                        ...
                        <div className='grid grid-cols-1 sm:grid-col-2 lg:grid-cols-3 xl:grid-cols-4 gap-6'>
